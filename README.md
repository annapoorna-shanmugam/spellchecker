...
- **Context-Aware Corrections**: Uses BERT/LSTM models for context-based suggestions
...
5. Click on 'Check Spelling' button to get the corrected words
...
- LSTM Model Based:
	– ‘medical_sentences.txt’ and ‘legal_sentences.txt’ files are used as terminology configuration
